...
public enum ErrorCode {
    ...
    // ------------------------------------------------------------------------
    // 습관 관리 관련 에러 (E40040 ~ E40049)
    // ------------------------------------------------------------------------

    @Schema(description = "습관 이름 미입력")
    HABIT_NAME_EMPTY(400, "E40040", "습관 이름을 입력해주세요."),

    @Schema(description = "습관 이름 길이 초과")
    HABIT_NAME_TOO_LONG(400, "E40041", "습관 이름이 너무 깁니다. (최대 50자)"),

    @Schema(description = "습관 빈도 설정 오류")
    INVALID_HABIT_FREQUENCY(400, "E40042", "올바르지 않은 습관 빈도입니다."),

    @Schema(description = "습관 중복 완료 시도")
    HABIT_ALREADY_COMPLETED_TODAY(400, "E40043", "오늘 이미 완료한 습관입니다."),
