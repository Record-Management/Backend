...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleMissingParameter(MissingServletRequestParameterException ex) {
        ...
        return ResponseEntity.badRequest()
                .body(ErrorResponse.of(ErrorCode.MISSING_REQUEST_PARAMETER, msg));
    }
    ...
    public ResponseEntity<ErrorResponse> handleTypeMismatch(MethodArgumentTypeMismatchException ex) {
        ...
        return ResponseEntity.badRequest()
                .body(ErrorResponse.of(ErrorCode.INVALID_TYPE_VALUE, msg));
    }
    ...
    public ResponseEntity<ErrorResponse> handleJsonParseError(HttpMessageNotReadableException ex) {
        ...
        return ResponseEntity.badRequest()
                .body(ErrorResponse.of(ErrorCode.JSON_PARSE_ERROR));
    }
    ...
    public ResponseEntity<ErrorResponse> handleJwtException(JwtException ex) {
        ...
        if (ex instanceof MalformedJwtException) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                    .body(ErrorResponse.of(ErrorCode.TOKEN_MALFORMED));
        } else if (ex instanceof SignatureException) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                    .body(ErrorResponse.of(ErrorCode.TOKEN_SIGNATURE_INVALID));
        } else {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotSupported(HttpRequestMethodNotSupportedException ex) {
        ...
        return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED)
                .body(ErrorResponse.of(ErrorCode.METHOD_NOT_ALLOWED, msg));
    }
    ...
    public ResponseEntity<ErrorResponse> handleUnsupportedMediaType(HttpMediaTypeNotSupportedException ex) {
        ...
        return ResponseEntity.status(HttpStatus.UNSUPPORTED_MEDIA_TYPE)
                .body(ErrorResponse.of(ErrorCode.UNSUPPORTED_MEDIA_TYPE, msg));
    }
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(NoHandlerFoundException ex) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(ErrorResponse.of(ErrorCode.API_ENDPOINT_NOT_FOUND, msg));
    }
    ...
    public ResponseEntity<ErrorResponse> handleRestClientException(RestClientException ex) {
        ...
        if (ex instanceof ResourceAccessException) {
            return ResponseEntity.status(HttpStatus.GATEWAY_TIMEOUT)
                    .body(ErrorResponse.of(ErrorCode.EXTERNAL_API_TIMEOUT));
        }
    ...
    public ResponseEntity<ErrorResponse> handleIllegalState(IllegalStateException ex) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ErrorResponse.of(ErrorCode.INTERNAL_SERVER_ERROR, "현재 요청을 처리할 수 없는 상태입니다."));
    }

    @ExceptionHandler(NullPointerException.class)
    public ResponseEntity<ErrorResponse> handleNullPointer(NullPointerException ex, HttpServletRequest req) {
