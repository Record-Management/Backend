...
public enum ErrorCode {
    ...
    DAILY_RECORD_LIMIT_EXCEEDED(400, "E40407", "하루에 등록할 수 있는 기록은 최대 2개입니다."),

    @Schema(description = "운동 기록 등록 제한 초과")
    EXERCISE_RECORD_LIMIT_EXCEEDED(400, "E40408", "하루에 등록할 수 있는 기록은 최대 2개입니다."),

    @Schema(description = "습관 기록 등록 제한 초과")
    HABIT_RECORD_LIMIT_EXCEEDED(400, "E40409", "하루에 등록할 수 있는 기록은 최대 2개입니다."),
    
    @Schema(description = "기록 종류 등록 제한 초과")
    RECORD_TYPE_LIMIT_EXCEEDED(400, "E40410", "하루에 등록할 수 있는 기록 종류는 최대 2가지입니다."),

    @Schema(description = "사용자 메인 기록 타입과 맞지 않음")
    INVALID_RECORD_TYPE_FOR_USER(400, "E40411", "해당 기록 타입은 사용자의 메인 기록 타입과 일치하지 않습니다."),

    @Schema(description = "습관 목표 기간 외 날짜")
    HABIT_RECORD_OUT_OF_PERIOD(400, "E40412", "습관 기록은 설정된 목표 기간 내에서만 등록할 수 있습니다."),
    ...
    @Schema(description = "이미 진행중인 목표가 존재")
    GOAL_ALREADY_IN_PROGRESS(409, "E40904", "이미 진행중인 목표가 존재합니다."),

    @Schema(description = "목표를 찾을 수 없음")
    GOAL_NOT_FOUND(404, "E40403", "목표를 찾을 수 없습니다."),
