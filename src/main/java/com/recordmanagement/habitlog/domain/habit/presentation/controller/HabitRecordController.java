...
public class HabitRecordController {
    ...
    @Operation(summary = "습관기록 작성", 
               ...
               **알림 발송 시스템**:
               ...
               ## 메인/서브 기록 결정 로직
               - **습관 타입 사용자의 첫 습관**: 해당 날짜에 첫 번째로 작성하는 습관은 isMainRecord 값에 관계없이 **무조건 메인 기록**
               - **이미 메인 습관 기록 존재**: 해당 날짜에 메인 습관이 있으면 **무조건 서브 기록**
               - **운동/일상 타입 사용자**: isMainRecord 명시적 설정값 사용, 미설정 시 서브 기록
