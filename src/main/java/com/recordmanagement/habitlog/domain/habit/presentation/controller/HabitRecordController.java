...
public class HabitRecordController {
    ...
    @Operation(summary = "습관기록 작성", 
               ...
               **🎯 습관 기록 특징:**
               - **서브 + 서브 가능**: 운동 타입 사용자가 습관만 등록
               - **메인 + 서브 가능**: 운동 타입 사용자가 운동(메인) + 습관(서브) 등록
               - **습관 타입 사용자**: 메인 습간 기록시 오늘부터 목표 종료일까지 자동 생성
               - **과거 날짜 제외**: 메인 습관 등록시 과거 날짜는 자동 생성하지 않음
               ...
               **📅 기록 제한:**
               ...
               - 습관 타입 사용자: 습관 목표 기간 내 날짜만 허용 (미래 날짜 가능)
    ...
    @Operation(summary = "습관기록 수정", 
               ...
               **⚙️ 자동 처리 (습관 타입 사용자만):**
               - 서브 → 메인 전환시: 오늘부터 목표 종료일까지 모든 메인 기록이 새 습관으로 업데이트
               - 메인 기록의 습관 타입 변경시: 동일하게 일괄 업데이트
               - **과거 날짜 제외**: 오늘 이전 날짜는 자동 업데이트하지 않음
