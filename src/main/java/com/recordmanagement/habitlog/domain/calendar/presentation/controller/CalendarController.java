...
public class CalendarController {
    ...
    @Operation(summary = "캘린더 조회", description = """
            ...
            - 메인 기록 타입이 HABIT인 사용자의 경우, **오늘부터 목표 종료일까지** 메인 습관 기록이 자동 생성됩니다
            - **과거 날짜 제외**: 메인 습관 등록/수정시 과거 날짜는 자동 생성하지 않음
            - 자동 생성된 기록은 isMainRecord: true, isCompleted: false로 시작하며 사용자가 완료 처리 가능합니다
            - 메인 습관 기록 수정시 오늘부터 목표 종료일까지의 모든 메인 기록이 동일한 습관 타입으로 자동 업데이트됩니다
            
            ### 📋 사용자 타입별 캘린더 특징
            **습관 타입 사용자 (HABIT)**:
            - 오늘부터 목표 종료일까지 메인 습관 기록이 자동 생성됨
            - 메인 습관 수정시 오늘부터 목표 종료일까지의 모든 기록이 동기화됨
            - 과거 날짜는 자동 생성/수정되지 않음
